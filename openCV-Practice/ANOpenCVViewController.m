//
//  ANOpenCVViewController.m
//  openCV-Practice
//
//  Created by Qianrun on 16/7/14.
...
@interface ANOpenCVViewController ()<AVCaptureVideoDataOutputSampleBufferDelegate>
...
@implementation ANOpenCVViewController
#pragma mark - 控制器视图方法
- (void)viewDidLoad {
    [super viewDidLoad];
    
//    _shapeLayer = [CAShapeLayer layer];
//    _shapeLayer.frame = _imgView.bounds;
//    //    _shapeLayer.backgroundColor = [[UIColor grayColor] colorWithAlphaComponent:0.5].CGColor;
//    [_imgView.layer addSublayer:_shapeLayer];
...
//    _shapeLayer.fillColor = [UIColor clearColor].CGColor;
    ...
    [self.imgView.layer addSublayer:self.addImgView.layer];
}
       ...
       fromConnection:(AVCaptureConnection *)connection
{
    ...
    if (rectArray.count > 0) {
        ...
        for (NSNumber* rectValue in rectArray) {
            ...
            rect = [self convertRectFromRect:rect toSize:_imgView.bounds.size];
...
//            weakSelf.shapeLayer.path = totalPath.CGPath;
            ...
            CGRect rect = totalPath.bounds;
            CGPoint point = totalPath.currentPoint;
            rect.origin = point;
            
            self.addImgView.frame = rect;
...
- (UIImageView *)addImgView {
    ...
    if (!_addImgView) {
        ...
        _addImgView.backgroundColor = [UIColor blueColor];
        
        _addImgView.image = [UIImage imageNamed:@"a.jpg"];
        _addImgView.contentMode = UIViewContentModeScaleAspectFill;
        _addImgView.clipsToBounds = YES;
    }
    return _addImgView;
}
...
//    UIImage * image2 = [UIImage imageNamed:@"2.png"];
    ...
    [self.addImgView.image drawInRect:self.addImgView.frame];
    ...
    NSDictionary *userIfo = @{@"newImg" : resultingImage};
    
//    [[NSNotificationCenter defaultCenter]postNotificationName:@"image" object:userIfo];
    [[NSNotificationCenter defaultCenter]postNotificationName:@"image" object:nil userInfo:userIfo];
